========================================================================
    ACTIVE TEMPLATE LIBRARY : CopyUncPath Project Overview
========================================================================

AppWizard has created this CopyUncPath project for you to use as the starting point for
...
CopyUncPath.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CopyUncPath.h)
        GUID definitions                                (CopyUncPath_i.c)
        A type library                                  (CopyUncPath.tlb)
        Marshaling code                                 (CopyUncPath_p.c and dlldata.c)

CopyUncPath.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in CopyUncPath.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named CopyUncPath.pch and a precompiled types file named StdAfx.obj.
...
CopyUncPathps.vcxproj
	...
	dlldata.c, CopyUncPath_i.c and CopyUncPath_p.c which are required
	to build the proxy/stub DLL.

CopyUncPathps.vcxproj.filters
